# Assamese InScript (Litogram)

Linux gap-port of the Microsoft Assamese InScript standard (xkb has none).

Generated from the verified litogram layout definition
(`layouts/as-IN-linux.json`) by keymapper's gen-os-artifacts —
